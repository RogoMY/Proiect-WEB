document.addEventListener('DOMContentLoaded', function() {
  ...
  function displayCategoryDetails(categoryName) {
    const details = {
      'Category1': [
        { title: 'Item 1', description: 'Description 1', link: 'http://example.com/1' },
        { title: 'Item 2', description: 'Description 2', link: 'http://example.com/2' }
      ],
      'Category2': [
        { title: 'Item 3', description: 'Description 3', link: 'http://example.com/3' },
        { title: 'Item 4', description: 'Description 4', link: 'http://example.com/4' }
      ]
    };
  ...
  // Add logout event listener for manage-content page
